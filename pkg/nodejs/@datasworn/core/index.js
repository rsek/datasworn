...
// src/pkg-core/index.ts
var pkg_core_exports = {};
__export(pkg_core_exports, {
  Tools: () => tools_exports
});
module.exports = __toCommonJS(pkg_core_exports);
...
var import_nanomatch = __toESM(require("nanomatch"), 1);
...
var IdParser = class _IdParser {
  ...
  get matcher() {
    if (this.#matcher == null) {
      const matcher = import_nanomatch.default.matcher(this.id);
