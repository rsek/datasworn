...
namespace Datasworn
{
    ...
    /// columns, one `result` column, and one `detail` column.
    /// </summary>
    public class OracleCollectionTableSharedDetails : OracleCollection
    {
        [JsonPropertyName("oracle_type")]
        public string OracleType { get => "table_shared_details"; }
        ...
        public OracleCollectionTableSharedDetailsColumnLabels ColumnLabels { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public IDictionary<string, OracleColumnDetails> Contents { get; set; }
