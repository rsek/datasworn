...
namespace Datasworn
{
    public class OracleRollableColumnText2 : OracleRollable
    {
        [JsonPropertyName("oracle_type")]
        public string OracleType { get => "column_text2"; }
        ...
        public OracleRollableColumnText2Type Type_ { get; set; }
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public OracleRollableColumnText2RecommendedRolls RecommendedRolls { get; set; }
