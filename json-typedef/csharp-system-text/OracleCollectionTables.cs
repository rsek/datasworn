...
{
    /// <summary>
    /// An OracleCollection that represents a category or grouping of tables,
    /// which may themselves be `OracleTablesCollection`s.
    /// </summary>
    public class OracleCollectionTables : OracleCollection
    {
        ...
        public OracleCollectionTablesType Type_ { get; set; }
