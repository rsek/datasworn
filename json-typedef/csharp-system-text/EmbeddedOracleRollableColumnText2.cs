...
namespace Datasworn
{
    public class EmbeddedOracleRollableColumnText2 : EmbeddedOracleRollable
    {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public EmbeddedOracleRollableColumnText2RecommendedRolls RecommendedRolls { get; set; }
