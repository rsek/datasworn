...
@JsonSerialize
public class EmbeddedMoveNoRoll extends EmbeddedMove {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private EmbeddedMoveNoRollType type;
     ...
     * Getter for type.<p>
     */
    public EmbeddedMoveNoRollType getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedMoveNoRollType type) {
        this.type = type;
    }
