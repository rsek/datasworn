 ...
 */
@JsonSerialize
public class SelectValueField {
    @JsonProperty("choices")
    private Map<String, SelectValueFieldChoice> choices;

    @JsonProperty("field_type")
    private SelectValueFieldFieldType fieldType;
     ...
     */
    public SelectValueFieldFieldType getFieldType() {
        return fieldType;
    }
     ...
     */
    public void setFieldType(SelectValueFieldFieldType fieldType) {
