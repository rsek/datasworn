...
@JsonSerialize
public class EmbeddedOracleRollableColumnText2 extends EmbeddedOracleRollable {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private EmbeddedOracleRollableColumnText2Type type;
    ...
    private EmbeddedOracleRollableColumnText2RecommendedRolls recommendedRolls;
    ...
    public EmbeddedOracleRollableColumnText2() {
    }
     ...
     * Getter for type.<p>
     */
    public EmbeddedOracleRollableColumnText2Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedOracleRollableColumnText2Type type) {
        this.type = type;
    }
     ...
     */
    public EmbeddedOracleRollableColumnText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(EmbeddedOracleRollableColumnText2RecommendedRolls recommendedRolls) {
