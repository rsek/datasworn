 ...
 */
@JsonSerialize
public class AssetOptionFieldSelectEnhancementChoiceChoice extends AssetOptionFieldSelectEnhancementChoice {
    @JsonProperty("label")
    private Label label;
    ...
    public AssetOptionFieldSelectEnhancementChoiceChoice() {
    }
