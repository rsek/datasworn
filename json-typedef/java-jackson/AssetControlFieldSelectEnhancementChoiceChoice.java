 ...
 */
@JsonSerialize
public class AssetControlFieldSelectEnhancementChoiceChoice extends AssetControlFieldSelectEnhancementChoice {
    @JsonProperty("label")
    private Label label;
    ...
    public AssetControlFieldSelectEnhancementChoiceChoice() {
    }
