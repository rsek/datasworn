...
public class MoveActionRollEnhancement {
    ...
    private MoveActionRollEnhancementRollType rollType;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty("trigger")
    private TriggerActionRollEnhancement trigger;

    public MoveActionRollEnhancement() {
    }
     ...
     */
    public MoveActionRollEnhancementRollType getRollType() {
        return rollType;
    }
     ...
     * addition to any other restrictions made by other properties.
     */
    public void setRollType(MoveActionRollEnhancementRollType rollType) {
