 ...
 */
@JsonSerialize
public class OracleTableRollableTableText2 extends OracleTableRollable {
    @JsonProperty("_id")
    ...
    private OracleTableRollableTableText2ColumnLabels columnLabels;
    ...
    private OracleTableRollableTableText2RecommendedRolls recommendedRolls;
    ...
    public OracleTableRollableTableText2() {
    }
     ...
     */
    public OracleTableRollableTableText2ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(OracleTableRollableTableText2ColumnLabels columnLabels) {
     ...
     */
    public OracleTableRollableTableText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleTableRollableTableText2RecommendedRolls recommendedRolls) {
