 ...
 */
@JsonSerialize
public class OracleRollableTableTableText2 extends OracleRollableTable {
    @JsonProperty("_id")
    ...
    private OracleRollableTableTableText2ColumnLabels columnLabels;
    ...
    @JsonProperty("type")
    private OracleRollableTableTableText2Type type;
    ...
    private OracleRollableTableTableText2RecommendedRolls recommendedRolls;
    ...
    public OracleRollableTableTableText2() {
    }
     ...
     * Getter for type.<p>
     */
    public OracleRollableTableTableText2Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleRollableTableTableText2Type type) {
        this.type = type;
    }
     ...
     */
    public OracleRollableTableTableText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleRollableTableTableText2RecommendedRolls recommendedRolls) {
