...
@JsonSerialize
public class EmbeddedOracleRollableColumnText3 extends EmbeddedOracleRollable {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private EmbeddedOracleRollableColumnText3Type type;
    ...
    private EmbeddedOracleRollableColumnText3RecommendedRolls recommendedRolls;
    ...
    public EmbeddedOracleRollableColumnText3() {
    }
     ...
     * Getter for type.<p>
     */
    public EmbeddedOracleRollableColumnText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedOracleRollableColumnText3Type type) {
        this.type = type;
    }
     ...
     */
    public EmbeddedOracleRollableColumnText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(EmbeddedOracleRollableColumnText3RecommendedRolls recommendedRolls) {
