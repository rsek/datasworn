...
public class AssetConditionMeter {
    ...
    private AssetConditionMeterFieldType fieldType;
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty("moves")
    private AssetConditionMeterMoves moves;

    public AssetConditionMeter() {
    }
     ...
     */
    public AssetConditionMeterFieldType getFieldType() {
        return fieldType;
    }
     ...
     */
    public void setFieldType(AssetConditionMeterFieldType fieldType) {
     ...
     */
    public AssetConditionMeterMoves getMoves() {
        return moves;
    }
     ...
     * suffer and recovery moves.
     */
    public void setMoves(AssetConditionMeterMoves moves) {
        this.moves = moves;
    }
}
