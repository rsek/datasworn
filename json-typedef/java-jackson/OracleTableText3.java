...
public class OracleTableText3 {
    ...
    private OracleTableText3ColumnLabels columnLabels;
    ...
    private OracleTableText3OracleType oracleType;

    @JsonProperty("rows")
    private List<OracleRollableRowText3> rows;

    @JsonProperty("type")
    private OracleTableText3Type type;
    ...
    private OracleTableText3RecommendedRolls recommendedRolls;
     ...
     */
    public OracleTableText3ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     */
    public void setColumnLabels(OracleTableText3ColumnLabels columnLabels) {
     ...
     */
    public OracleTableText3OracleType getOracleType() {
        return oracleType;
    }
     ...
     */
    public void setOracleType(OracleTableText3OracleType oracleType) {
     ...
     * Getter for type.<p>
     */
    public OracleTableText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleTableText3Type type) {
        this.type = type;
    }
     ...
     */
    public OracleTableText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleTableText3RecommendedRolls recommendedRolls) {
