...
@JsonSerialize
public class OracleColumnText3 {
    @JsonProperty("_id")
    ...
    private OracleColumnText3OracleType oracleType;

    @JsonProperty("rows")
    private List<OracleRollableRowText3> rows;

    @JsonProperty("type")
    private OracleColumnText3Type type;
    ...
    private OracleColumnText3RecommendedRolls recommendedRolls;
     ...
     */
    public OracleColumnText3OracleType getOracleType() {
        return oracleType;
    }
     ...
     */
    public void setOracleType(OracleColumnText3OracleType oracleType) {
     ...
     * Getter for type.<p>
     */
    public OracleColumnText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleColumnText3Type type) {
        this.type = type;
    }
     ...
     */
    public OracleColumnText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleColumnText3RecommendedRolls recommendedRolls) {
