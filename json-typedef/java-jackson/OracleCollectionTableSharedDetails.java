...
public class OracleCollectionTableSharedDetails extends OracleCollection {
    ...
    private Map<String, OracleColumnDetails> contents;
    ...
    public OracleCollectionTableSharedDetails() {
    }
     ...
     */
    public OracleCollectionTableSharedDetailsColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     */
    public Map<String, OracleColumnDetails> getContents() {
        return contents;
    }
     ...
     */
    public void setContents(Map<String, OracleColumnDetails> contents) {
