 ...
 */
@JsonSerialize
public class OracleRollableTableText3 extends OracleRollable {
    @JsonProperty("_id")
    ...
    private OracleRollableTableText3ColumnLabels columnLabels;
    ...
    @JsonProperty("type")
    private OracleRollableTableText3Type type;
    ...
    private OracleRollableTableText3RecommendedRolls recommendedRolls;
    ...
    public OracleRollableTableText3() {
    }
     ...
     */
    public OracleRollableTableText3ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     */
    public void setColumnLabels(OracleRollableTableText3ColumnLabels columnLabels) {
     ...
     * Getter for type.<p>
     */
    public OracleRollableTableText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleRollableTableText3Type type) {
        this.type = type;
    }
     ...
     */
    public OracleRollableTableText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleRollableTableText3RecommendedRolls recommendedRolls) {
