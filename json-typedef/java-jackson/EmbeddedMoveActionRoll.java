...
@JsonSerialize
public class EmbeddedMoveActionRoll extends EmbeddedMove {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private EmbeddedMoveActionRollType type;
     ...
     * Getter for type.<p>
     */
    public EmbeddedMoveActionRollType getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedMoveActionRollType type) {
        this.type = type;
    }
