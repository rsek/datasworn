...
public class OracleTableText2 {
    ...
    private OracleTableText2ColumnLabels columnLabels;
    ...
    private OracleTableText2OracleType oracleType;

    @JsonProperty("rows")
    private List<OracleRollableRowText2> rows;

    @JsonProperty("type")
    private OracleTableText2Type type;
    ...
    private OracleTableText2RecommendedRolls recommendedRolls;
     ...
     */
    public OracleTableText2ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(OracleTableText2ColumnLabels columnLabels) {
     ...
     */
    public OracleTableText2OracleType getOracleType() {
        return oracleType;
    }
     ...
     */
    public void setOracleType(OracleTableText2OracleType oracleType) {
     ...
     * Getter for type.<p>
     */
    public OracleTableText2Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleTableText2Type type) {
        this.type = type;
    }
     ...
     */
    public OracleTableText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleTableText2RecommendedRolls recommendedRolls) {
