...
@JsonSerialize
public class OracleRollableColumnText2 extends OracleRollable {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private OracleRollableColumnText2Type type;
    ...
    private OracleRollableColumnText2RecommendedRolls recommendedRolls;
    ...
    public OracleRollableColumnText2() {
    }
     ...
     * Getter for type.<p>
     */
    public OracleRollableColumnText2Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleRollableColumnText2Type type) {
        this.type = type;
    }
     ...
     */
    public OracleRollableColumnText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleRollableColumnText2RecommendedRolls recommendedRolls) {
