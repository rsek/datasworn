 ...
 */
@JsonSerialize
public class DelveSiteThemeFeature {
    @JsonProperty("_id")
    private DelveSiteThemeFeatureId id;
    ...
    public DelveSiteThemeFeature() {
    }

    /**
     * Getter for id.<p>
     */
    public DelveSiteThemeFeatureId getId() {
        return id;
    }
     ...
     * Setter for id.<p>
     */
    public void setId(DelveSiteThemeFeatureId id) {
        this.id = id;
    }
