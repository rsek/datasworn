 ...
 */
@JsonSerialize
public class OracleRollableTableText2 extends OracleRollable {
    @JsonProperty("_id")
    ...
    private OracleRollableTableText2ColumnLabels columnLabels;
    ...
    @JsonProperty("type")
    private OracleRollableTableText2Type type;
    ...
    private OracleRollableTableText2RecommendedRolls recommendedRolls;
    ...
    public OracleRollableTableText2() {
    }
     ...
     */
    public OracleRollableTableText2ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(OracleRollableTableText2ColumnLabels columnLabels) {
     ...
     * Getter for type.<p>
     */
    public OracleRollableTableText2Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleRollableTableText2Type type) {
        this.type = type;
    }
     ...
     */
    public OracleRollableTableText2RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleRollableTableText2RecommendedRolls recommendedRolls) {
