...
@JsonSerialize
public class EmbeddedOracleTableText3 {
    @JsonProperty("_id")
    private EmbeddedOracleRollableId id;

    @JsonProperty("column_labels")
    private EmbeddedOracleTableText3ColumnLabels columnLabels;
    ...
    private EmbeddedOracleTableText3OracleType oracleType;

    @JsonProperty("rows")
    private List<OracleRollableRowText3> rows;

    @JsonProperty("type")
    private EmbeddedOracleTableText3Type type;
    ...
    private EmbeddedOracleTableText3RecommendedRolls recommendedRolls;
    ...
    public EmbeddedOracleTableText3() {
    }
     ...
     */
    public EmbeddedOracleTableText3OracleType getOracleType() {
        return oracleType;
    }
     ...
     */
    public void setOracleType(EmbeddedOracleTableText3OracleType oracleType) {
     ...
     * Getter for type.<p>
     */
    public EmbeddedOracleTableText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedOracleTableText3Type type) {
        this.type = type;
    }
     ...
     */
    public EmbeddedOracleTableText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(EmbeddedOracleTableText3RecommendedRolls recommendedRolls) {
