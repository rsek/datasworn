...
@JsonSerialize
public class EmbeddedOracleRollableTableText3 extends EmbeddedOracleRollable {
    @JsonProperty("_id")
    private EmbeddedOracleRollableId id;

    @JsonProperty("column_labels")
    private EmbeddedOracleRollableTableText3ColumnLabels columnLabels;
    ...
    @JsonProperty("rows")
    private List<OracleTableRowText3> rows;

    @JsonProperty("type")
    private EmbeddedOracleRollableTableText3Type type;
    ...
    private EmbeddedOracleRollableTableText3RecommendedRolls recommendedRolls;
    ...
    public EmbeddedOracleRollableTableText3() {
    }
     ...
     */
    public EmbeddedOracleRollableTableText3ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(EmbeddedOracleRollableTableText3ColumnLabels columnLabels) {
     ...
     */
    public List<OracleTableRowText3> getRows() {
        return rows;
    }
     ...
     * An array of objects, each representing a single row of the table.
     */
    public void setRows(List<OracleTableRowText3> rows) {
        this.rows = rows;
    }
     ...
     * Getter for type.<p>
     */
    public EmbeddedOracleRollableTableText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedOracleRollableTableText3Type type) {
        this.type = type;
    }
     ...
     */
    public EmbeddedOracleRollableTableText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(EmbeddedOracleRollableTableText3RecommendedRolls recommendedRolls) {
