 ...
 */
@JsonSerialize
public class OracleRollableTableTableText3 extends OracleRollableTable {
    @JsonProperty("_id")
    ...
    private OracleRollableTableTableText3ColumnLabels columnLabels;
    ...
    @JsonProperty("type")
    private OracleRollableTableTableText3Type type;
    ...
    private OracleRollableTableTableText3RecommendedRolls recommendedRolls;
    ...
    public OracleRollableTableTableText3() {
    }
     ...
     */
    public OracleRollableTableTableText3ColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(OracleRollableTableTableText3ColumnLabels columnLabels) {
     ...
     * Getter for type.<p>
     */
    public OracleRollableTableTableText3Type getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(OracleRollableTableTableText3Type type) {
        this.type = type;
    }
     ...
     */
    public OracleRollableTableTableText3RecommendedRolls getRecommendedRolls() {
     ...
     */
    public void setRecommendedRolls(OracleRollableTableTableText3RecommendedRolls recommendedRolls) {
