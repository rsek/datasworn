...
@JsonSerialize
public class EmbeddedMoveProgressRoll extends EmbeddedMove {
    @JsonProperty("_id")
    ...
    @JsonProperty("type")
    private EmbeddedMoveProgressRollType type;
    ...
    public EmbeddedMoveProgressRoll() {
    }
     ...
     * Getter for type.<p>
     */
    public EmbeddedMoveProgressRollType getType() {
        return type;
    }
     ...
     * Setter for type.<p>
     */
    public void setType(EmbeddedMoveProgressRollType type) {
        this.type = type;
    }
