 ...
 */
@JsonSerialize
public class OracleCollectionTableSharedResults extends OracleCollection {
    @JsonProperty("_id")
    ...
    public OracleCollectionTableSharedResults() {
    }
     ...
     */
    public OracleCollectionTableSharedResultsColumnLabels getColumnLabels() {
        return columnLabels;
    }
     ...
     * roll column showing the dice range (`min` and `max` on each table row).
     */
    public void setColumnLabels(OracleCollectionTableSharedResultsColumnLabels columnLabels) {
