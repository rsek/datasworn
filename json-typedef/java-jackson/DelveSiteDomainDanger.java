 ...
 */
@JsonSerialize
public class DelveSiteDomainDanger {
    @JsonProperty("_id")
    private DelveSiteDomainDangerId id;
    ...
    public DelveSiteDomainDanger() {
    }

    /**
     * Getter for id.<p>
     */
    public DelveSiteDomainDangerId getId() {
        return id;
    }
     ...
     * Setter for id.<p>
     */
    public void setId(DelveSiteDomainDangerId id) {
        this.id = id;
    }
