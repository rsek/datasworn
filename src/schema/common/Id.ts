...
// })
// const AssetAbilityMoveId = Type.String({
// 	$id: 'AssetAbilityMoveId',
...
// })
// export const MoveId = Type.Union([StandardMoveId, AssetAbilityMoveId], {
...
// 			pattern: StandardMoveId.pattern + '|' + AssetAbilityMoveId.pattern
// 		})
// 	}
// })
...
// const AssetAbilityMoveIdWildcard = Type.String({
// 	$id: 'AssetAbilityMoveIdWildcard',
...
// 	[StandardMoveIdWildcard, AssetAbilityMoveIdWildcard],
// 	{
...
// 			schema: JtdType.String({
// 				pattern:
// 					StandardMoveIdWildcard.pattern +
// 					'|' +
// 					AssetAbilityMoveIdWildcard.pattern
// 			})
// 		}
// 	}
// )
...
export default { RulesetId, ExpansionId, DictKey, ...ids }
