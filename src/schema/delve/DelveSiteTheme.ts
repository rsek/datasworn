		...
		Type.Object({
			...
			features: Type.Intersect(
				[
					...
					Type.Tuple([
						StaticRowPartial({ roll: { min: 1, max: 4 } }),
						StaticRowPartial({ roll: { min: 5, max: 8 } }),
						StaticRowPartial({ roll: { min: 9, max: 12 } }),
						StaticRowPartial({ roll: { min: 13, max: 16 } }),
						StaticRowPartial({ roll: { min: 17, max: 20 } })
					])
				],
				{
					[JsonTypeDef]: {
			...
			dangers: Type.Intersect(
				[
					...
					Type.Tuple([
						StaticRowPartial({ roll: { min: 1, max: 5 } }),
						StaticRowPartial({ roll: { min: 6, max: 10 } }),
						StaticRowPartial({ roll: { min: 11, max: 12 } }),
						StaticRowPartial({ roll: { min: 13, max: 14 } }),
						StaticRowPartial({ roll: { min: 15, max: 16 } }),
						StaticRowPartial({ roll: { min: 17, max: 18 } }),
						StaticRowPartial({ roll: { min: 19, max: 20 } }),
						StaticRowPartial({ roll: { min: 21, max: 22 } }),
						StaticRowPartial({ roll: { min: 23, max: 24 } }),
						StaticRowPartial({ roll: { min: 25, max: 26 } }),
						StaticRowPartial({ roll: { min: 27, max: 28 } }),
						StaticRowPartial({ roll: { min: 29, max: 30 } })
					])
				],
				{
					[JsonTypeDef]: {
